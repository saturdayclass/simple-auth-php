<?php
  ...
  /* Ini adalah variable koneksi, yang digunakan untuk mengkoneksikan database ke halaman web kita.
    ...
    4. Nama databases, disini saya membuat database bernama db_auth sebagai contoh. Jika teman-teman menggunakan database lain, sesuaikan juga nama database disini, nama table dan field yang ada dalam kodingan folder ini. Baik dalam file index.php maupun file lainya, yang membutuhkan field table teman-teman.
  */
  $koneksi = mysqli_connect('localhost', 'root', '', 'db_auth');
